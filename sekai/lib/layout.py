...
from sonolus.script.runtime import aspect_ratio, is_play, is_watch, runtime_ui, safe_area, screen, set_background, time
...
def compute_hitbox(lane: float, size: float, leniency: float, y_offset: float = 0.0) -> Hitbox:
    ...
    b_y = screen().b if Options.hitbox_range == HitboxRange.UNLIMITED else note_y - vertical_extent
