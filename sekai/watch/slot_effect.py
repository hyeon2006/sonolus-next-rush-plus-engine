...
class WatchSlotGlowEffect(WatchArchetype):
    ...
    def initialize(self):
        self.end_time = self.start_time + SLOT_GLOW_EFFECT_DURATION * Options.note_effect_duration

    def spawn_time(self) -> float:
        return self.start_time

    def despawn_time(self) -> float:
        return self.start_time + SLOT_GLOW_EFFECT_DURATION * Options.note_effect_duration
...
class WatchSlotEffect(WatchArchetype):
    ...
    def initialize(self):
        self.end_time = self.start_time + SLOT_EFFECT_DURATION * Options.note_effect_duration

    def spawn_time(self) -> float:
        return self.start_time

    def despawn_time(self) -> float:
        return self.start_time + SLOT_EFFECT_DURATION * Options.note_effect_duration
